...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <pattern id="check.note">
    <rule context="note" role="warning">
      ...
      <report test="$paragraphs=1"
        see="http://www.oxygenxml.com/dita/styleguide/webhelp-feedback/index.html#Artefact/Syntax_and_Markup/c_Paragraphs_within_Notes.html"
      ...
      <report test="matches(., 'Note:')"
        see="http://www.oxygenxml.com/dita/styleguide/webhelp-feedback/index.html#Artefact/Authoring_Concepts/c_Content_or_Form.html"
        > Please remove the "Note:" text that stars your note! The mark-up of that element in DITA
