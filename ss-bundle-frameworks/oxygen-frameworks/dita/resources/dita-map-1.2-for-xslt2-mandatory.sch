...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" 
    ...
    <pattern id="topichead_navtitle">
        <rule context="*[contains(@class, ' mapgroup-d/topichead ')]">
            <assert test="@navtitle | *[contains(@class, ' map/topicmeta ')]/*[contains(@class, ' topic/navtitle ')]" role="warning" see="http://docs.oasis-open.org/dita/v1.2/os/spec/langref/topichead.html#topichead">
